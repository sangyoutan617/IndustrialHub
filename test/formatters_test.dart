...
void main() {
  group('formatNumber', () {
    ...
    test('a number below the grouping threshold has no comma at all', () {
  ...
  group('formatUnits', () {
    ...
    test('fractional values keep one decimal place, still comma-grouped', () {
  ...
  group('formatWhole', () {
    ...
    test('comma-groups a whole-number result', () {
      expect(formatWhole(40000), '40,000');
    });
  });

  group('formatCurrency', () {
    test('prefixes RM and comma-groups the whole part', () {
